...

{
    ...
    //        
    //        CFRelease(thisPerson); // ④其中第①行代码调用函数ABRecordGetRecordID是获取选中记录的ID，其中ID为ABRecordID类型。为了传递这个ID给DetailViewController视图控制器，DetailViewController视图控制器定义了personIDAsNumber属性，在第③行将ID给personIDAsNumber属性
    //        
    //    } 
